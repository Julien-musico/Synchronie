...
def auto_fix_database():
    ...
    try:
        ...
        # Vérifier si nous sommes sur PostgreSQL
        engine_name = db.engine.name
        logger.info(f"📊 Type de base de données: {engine_name}")
        
        if engine_name == 'postgresql':
            # Requête PostgreSQL pour vérifier les colonnes
            ...
            # Requête SQLite pour vérifier les colonnes
            ...
            # Simuler le même format que PostgreSQL
